...
import CreateForm from 'components/formats/create'

import QueryParamsProvider from 'providers/QueryParamsProvider'
import ListTable from 'components/formats/table'
import Filters from 'components/formats/filters'
  ...
  return (
    <QueryParamsProvider allowValues={['page', 'search', 'status', 'category']}>
      <section className='headerSection'>
        <Typography fontSize='24px' component='h2' fontWeight='bold'>Formatos</Typography>
